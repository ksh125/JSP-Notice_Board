...
<body>
	<%
		...
		int bbsID = 0;
		if(request.getAttribute("bbsID") != null) {
		...
		if(bbsID == 0) {
			...
			script.println("alter('게시글이 존재하지 않습니다!')");
    ...
    <div class = "container">
    	<div class = "row">
    		...
    		<% if(userID != null && userID.equals(bbs.getUserID())) {%>
    			...
    			<a onclick="return contirm('삭제하시겠습니까?')"
    				href="deleteAction.jsp?bbsID=<%= bbsID %>"
    				class="brn btn-danger">삭제</a>
    		<% } %>
    	</div>
    </div>
